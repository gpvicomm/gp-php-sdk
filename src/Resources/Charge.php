...
class Charge extends Resource
{
    ...
    public function create(string $token, array $order, array $user): stdClass
    {
        ...
        throw new VicommErrorException("Error on create charge.");
    }
                              ...
                              array $user): stdClass
    {
        ...
        throw new VicommErrorException("Error on create charge authorization.");
    }
    ...
    public function capture(string $transactionId, float $amount = null): stdClass
    {
        ...
        throw new VicommErrorException("Error on capture charge.");
    }
                           ...
                           bool $more_info = null): stdClass
    {
        ...
        throw new VicommErrorException("Error on verify charge.");
    }
    ...
    public function refund(string $transactionId, float $amount = null, bool $more_info = null): stdClass
    {
        ...
        throw new VicommErrorException("Error on refund charge.");
    }
}